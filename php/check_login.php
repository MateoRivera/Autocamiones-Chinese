	...
	<body>
		<div class="shadow-none p-3 mb-5 rounded container" id="recuadro">
			...
			if(isset($_REQUEST['pass'])==false){
				...
				$registros = mysqli_query($conexion, "SELECT * from users where id='$_REQUEST[pass]'") or die("Problemas en el select:".mysqli_error($conexion));
				if ($reg = mysqli_fetch_array($registros)) {
					session_start();
					echo "<META HTTP-EQUIV='REFRESH' content='0;URL=../CRUD'>";
					$_SESSION['id']=$reg['id'];
